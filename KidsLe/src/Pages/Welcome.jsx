...
// const Welcome = () => {
//   return (
//     <div className="min-h-screen bg-pin flex flex-col items-center justify-center p-6">
//       <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
//         <h1 className="text-4xl font-bold mb-6 text-darkg">Welcome!</h1>
//         <p className="text-darkg mb-8">
//           Discover a fun and interactive learning experience designed just for kids.
//         </p>
// <div className="space-y-4">
//   <Link 
//     to="/login" 
//     className="block w-full bg-blu text-white py-3 rounded-lg hover:bg-blu/80 transition duration-300"
//   >
//     Login
//   </Link>
//   <Link 
//     to="/register" 
//     className="block w-full border-2 border-blu text-blu py-3 rounded-lg hover:bg-blu/10 transition duration-300"
//   >
//     Register
//   </Link>
// </div>
